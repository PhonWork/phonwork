...
<html>
<head>
  <title>4.11 Phonetic descriptions</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Complete the phonetic description</h1>
	
	<p>Fill in the blank:  <span id="question"></span></p>
  ...
  <script src="assets/js/ex/ex4_11.js"></script>
</body>
</html>
