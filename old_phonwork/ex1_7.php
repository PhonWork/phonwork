...
<html>
<head>
  <title>1.7 One of these vowels</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>One of these vowels is not like the others</h1>

	Which of these words has a different vowel sound than the others?
  ...
  <script src="assets/js/ex/ex1_7.js"></script>
</body>
</html>
