...
<html>
<head>
  <title>4.6 Polish Fricative transcription</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
	...
	<span class="image fit"><img src="media/images/ex/polish_fricatives.gif" width="400px"></span>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex4_6.js"></script>
</body>
</html>
