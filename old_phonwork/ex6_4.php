...
<html>
<head>
  <title>Armenian voicing contrast</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Armenian voicing contrasts</h1>

	<span class="image fit"><img src="media/sounds/armenian/armenian.gif" width="400px"></span>

	<p>What Armenian word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex6_4.js"></script>
</body>
</html>
