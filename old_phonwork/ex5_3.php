...
<body onload="initialize()">
  ...
  <div id="wrapper">
	...
	<span class="image fit"><img src="media/sounds/french/vm.gif" width="400px"></span>

	<p>What French word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex5_3.js"></script>
</body>
</html>
