...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Mazatec phonation contrasts</h1>

	<span class="image fit"><img src="media/sounds/mazatec/mazatec.gif" width="400px"></span>

	<p>What Mazatec word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex6_5.js"></script>
</body>
</html>
