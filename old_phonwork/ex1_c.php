...
<html>
<head>
  <title>1.c  IPA practice, English 3</title>
  <meta charset="utf-8" />
...
<body onload="init_practice()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Practice reading and writing IPA: English 3</h1>
	
	<p>Work with a partner.  
<br>1. Person 1 sees the screen and reads out the word written below in IPA. <br>2. Person 2 writes an IPA transcription of what Person 1 said. 
...
<br>4. Take turns being 'person 1' and 'person 2'.
	...
	<p>Read this IPA transcription outloud for your partner: 
	  <span class="IPA" id="practice_item"></span></p>
  ...
  <script src="assets/js/ex/ex1_c.js"></script>
</body>
</html>
