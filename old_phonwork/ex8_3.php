...
<html>
<head>
  <title>Arabic pharyngealization</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Arabic (Syrian) pharyngealization</h1>

	<span class="image fit"><img src="media/sounds/arabic/arabic.gif" width="400px"></span>

	<p>What Arabic word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex8_3.js"></script>
</body>
</html>
