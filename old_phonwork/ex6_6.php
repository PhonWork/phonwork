...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Bruu phonation contrasts</h1>

	<span class="image fit"><img src="media/sounds/bruu/bru.gif" width="400px"></span>

	<p>What Bruu word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex6_6.js"></script>
</body>
</html>
