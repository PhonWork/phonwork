...
<html>
<head>
  <title>1.a  IPA practice, English 2</title>
  <meta charset="utf-8" />
...
<body onload="init_practice()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Practice reading and writing IPA: More English Consonants and Vowels</h1>
...
<br>4. Take turns being 'person 1' and 'person 2'.
  ...
  <script src="assets/js/ex/ex1_b.js"></script>
</body>
</html>
