...
<html>
<head>
  <title>Russian palatalization</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Russian palatalization</h1>

	<span class="image fit"><img src="media/sounds/russian/russian.gif" width="400px"></span>

	<p>What Russian word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex8_1.js"></script>
</body>
</html>
