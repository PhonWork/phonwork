...
<html>
<head>
  <title>Using Aerodynamic formulas</title>
  <meta charset="utf-8" />
...
<body onload="initialize(rand=0)">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Using Aerodynamic Formulas</h1>

	<img id="image_question" width="40%">
  ...
  <script src="assets/js/ex/ex5_5.js"></script>
</body>
</html>
