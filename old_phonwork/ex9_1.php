...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Quantity contrasts in Italian</h1>

	<span class="image fit"><img src="media/sounds/italian/im.gif" width="400px"></span>

	<p>What Italian word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex9_1.js"></script>
</body>
</html>
