...
<html>
<head>
  <title>3.1 Primary Cardinal Vowels</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>The Primary Cardinal Vowels</h1>

	<span class="image fit"><img src="images/ex/primary.png" width="400px"></span>

	<p>The primary cardinal vowels are numbered from 1 to 8, as in the figure.  Listen to the sound and 
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex3_1.js"></script>
</body>
</html>
