...
<html>
<head>
  <title>4.2 Active and Passive Articulators</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Active and Passive Articulators</h1>
	
	<p>For each phonetic symbol or place category give the active or passive articulator. </p>
	<p>What is the <span id="question"></span>
  ...
  <script src="assets/js/ex/ex4_2.js"></script>
</body>
</html>
