...
<html>
<head>
  <title>Phonological features</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Phonological features</h1>

	<p>What feature is found in the sound(s) in <span id="question"></span>?</p>
  ...
  <script src="assets/js/ex/ex11_1.js"></script>
</body>
</html>
