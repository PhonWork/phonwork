...
<html>
<head>
  <title>8.2 Nafaanra Place of Articulation</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>8.2 Nafaanra Place of Articulation</h1>
<p>Nafannra is a Niger-Congo language spoken in Ghana. Listen for the doubly articulated stops. This exercise is by Karee Garvin and Eric Wilbanks</p>

	 <span class="image fit"> <img id="image_question" width="400px"></span>
...
<p><span class="IPA" id="question"></span>

<input id="answerbox" type="text" onkeydown="if (event.keyCode == 13) check_answer()" placeholder="type answer here"></p>
  ...
  <script src="assets/js/ex/ex8_2.js"></script>
</body>
</html>
