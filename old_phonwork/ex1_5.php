...
<html>
<head>
  <title>1.5 Phonetic terms for English sounds</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Phonetic terms for English sounds</h1>
	<p>Be careful not to be confused by spellings.  These questions are about the sounds in the words.</p>
  ...
  <script src="assets/js/ex/ex1_5.js"></script>
</body>
</html>
