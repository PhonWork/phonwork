...
<body onload="initialize()">
  ...
  <div id="wrapper">
	...
	<span class="image fit"><img src="media/sounds/toda/toda4.gif" width="400px"></span>

	<p>What Toda word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex5_4.js"></script>
</body>
</html>
