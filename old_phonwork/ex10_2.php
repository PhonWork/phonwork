...
<body onload="load_guess('2')">
  ...
  <div id="wrapper">
	...
	<p>The horizontal axis is time, the traces are vertical movement of articulators.</p>
	  <p>blue = tongue tip vertical, red = tongue body vertical, green = lower lip vertical.</p>

	<canvas id="guess" width="300px" height="150px" style="border:1px solid #0000;" class="image fit"></canvas>
	...
	<p>made by: Eric Chen</p>
	<p>data: Westbury, J.R. (1994) 'X-ray Microbeam Speech
