...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Tone in Ibibio</h1>

	<span class="image fit"><img src="media/sounds/ibibio/im.gif" width="400px"></span>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex9_3.js"></script>
</body>
</html>
