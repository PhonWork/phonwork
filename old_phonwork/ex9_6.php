...
<body onload="initialize()">
  ...
  <div id="wrapper">
	...
	<span class="image fit"><img src="media/sounds/hmong/hmong.gif" width="400px"></span>

	<p>What Hmong word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex9_6.js"></script>
</body>
</html>
