...
<body onload="initialize()">
  ...
  <div id="wrapper">
	...
	<span class="image fit"><img src="media/sounds/sindhi/sindhi.gif" width="400px"></span>

	<p>What Sindhi word is this?</p>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex6_1.js"></script>
</body>
</html>
