...
<html>
<head>
  <title>Infrahyoid Muscles</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Infrahyoid muscles</h1>

	<span class="image fit"><img src="media/images/extrinsic_laryngeal_muscles.png" width="400px"></span>

	<p>What muscle is labelled with the letter (<span id="question"></span>)?</p>
  ...
  <script src="assets/js/ex/ex7_4.js"></script>
</body>
</html>
