...
<html>
<head>
  <title>4.7 Mandarin Fricative transcription</title>
  <meta charset="utf-8" />
...
<body onload="initialize()">
  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
	<h1>Mandarin Fricative Transcription</h1>

	<p>Type the English gloss of the word you hear.</p>

	<span class="image fit"><img src="media/images/ex/chinese_fricatives.gif" width="400px"></span>
...
<p><input id="audio_questions" type="button" onclick="document.getElementById('theaudio').play();document.getElementById('answerbox').focus();" value="play"></p>
  ...
  <script src="assets/js/ex/ex4_7.js"></script>
</body>
</html>
