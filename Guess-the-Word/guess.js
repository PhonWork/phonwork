...
//const root = 'http://linguistics.berkeley.edu/~kjohnson/Guess-the-Word/';
const root = 'Guess-the-Word/';
...
function drawMoving(row){
	...
	drawLine(jaw, 'red');
	drawPoints(tongue, 'blue', 5);
	drawPoints(jaw, 'red', 5);
	drawPoints(lips, 'green', 5);
}
